...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authSystem', '0010_alter_usermodel_avatar'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='presence', to='authSystem.usermodel', verbose_name='用户')),
            ],
            options={
                'verbose_name': '用户在线状态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(related_name='chat_rooms', to='authSystem.usermodel', verbose_name='成员列表')),
            ],
            options={
                'verbose_name': '聊天室',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_messages', to='authSystem.usermodel', verbose_name='发送者')),
            ],
            options={
                'verbose_name': '聊天消息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='authSystem.usermodel', verbose_name='接收用户')),
                ('sender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sent_notifications', to='authSystem.usermodel', verbose_name='发送用户')),
            ],
            options={
                'verbose_name': '用户通知',

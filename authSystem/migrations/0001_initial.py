    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('role_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authSystem.rolemodel', verbose_name='角色ID')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authSystem.usermodel', verbose_name='用户ID')),
            ],
            options={
                'db_table': 'user_roles',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('permission_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authSystem.permissionmodel', verbose_name='权限ID')),
                ('role_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authSystem.rolemodel', verbose_name='角色ID')),
            ],
            options={
